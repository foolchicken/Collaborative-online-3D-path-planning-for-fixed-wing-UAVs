...
tic
mpdata = GetDubinsMotionPrimitiveDataBase2dim(speed, gridres, thetadisNum, databasePointNum, dynamicCons, 'mpdatav30');
toc

tic
GetDubinsMotionPrimitiveDataBase2dimFreeTA(speed, gridres, thetadisNum, databasePointNum, dynamicCons, 'mpdataFTAv30');
toc
...
% for i = 1 : n
%     tic
%     motionPrimitive = GetMotionPrimitive(mpdata, [0 0 0], [100 20 deg2rad(0)]);
%     t(i) = toc;
